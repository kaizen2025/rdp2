...
const schema = `
    ...
    CREATE TABLE IF NOT EXISTS computers (id TEXT PRIMARY KEY, name TEXT NOT NULL, brand TEXT, model TEXT, serialNumber TEXT UNIQUE NOT NULL, status TEXT DEFAULT 'available', notes TEXT, specifications TEXT, warranty TEXT, location TEXT, condition TEXT, assetTag TEXT, maintenanceHistory TEXT, createdAt TEXT, createdBy TEXT, lastModified TEXT, modifiedBy TEXT, photo BLOB);
    ...
    CREATE TABLE IF NOT EXISTS technician_presence (id TEXT PRIMARY KEY, name TEXT, avatar TEXT, position TEXT, status TEXT, hostname TEXT, loginTime TEXT, lastActivity TEXT, photo BLOB);
